            ...
            <div>
                <div className="front-side">
                    ...
                    <div className="info-grid">
                        <div className="name">
                            <h2 className="padding10">{props.template.title}</h2>
                            <h5 className="">{props.template.subtitle}</h5>
                        </div>
                        <div className="addr">
                            ...
                            <p className="padding10">
                                <strong> {props.template.location}</strong>
                            </p>
                        </div>
                        <div className="phoneNo padding10">
                            ...
                            <p className="padding10">{props.template.phoneNumber}</p>
                        </div>
                        <div className="emailId padding10">
                            ...
                            <p className="email padding10">
                                <strong>{props.template.email}</strong></p>
                        </div>
                    </div>
                </div>
